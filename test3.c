...
int	main(void)
{
	...
	fflush(stdout);
	printf("11) standart PRINTF : |%5.4c|\n", 'n');
	ft_printf("11} my       PRINTF : |%5.4c|\n", 'n');
	fflush(stdout);
	ft_printf("--------------------%%s--------------------\n");
	...
	ft_printf("11) my       PRINTF : |%p|\n", NULL);
	 fflush(stdout);
	printf("12) standart PRINTF : |%5p|\n", NULL);
	ft_printf("12) my       PRINTF : |%5p|\n", NULL);
	 fflush(stdout);
	...
	fflush(stdout);
	printf("18) standart PRINTF : |%-20p|\n", "\0\0\0\0\0");
	ft_printf("18) my       PRINTF : |%-20p|\n", "\0\0\0\0\0");
	fflush(stdout);
	printf("19) standart PRINTF : |%-10.20p|\n", "\0\0\0\0\0");
	ft_printf("19) my       PRINTF : |%-10.20p|\n", "\0\0\0\0\0");
	fflush(stdout);
	printf("20) standart PRINTF : |%25.20p|\n", "\0\0\0\0\0");
	ft_printf("20) my       PRINTF : |%25.20p|\n", "\0\0\0\0\0");
	fflush(stdout);
	printf("21) standart PRINTF : |%16.p|\n", NULL);
	ft_printf("21) my       PRINTF : |%16.p|\n", NULL);
	fflush(stdout);
	printf("22) standart PRINTF : |%-16.p|\n", NULL);
	ft_printf("22) my       PRINTF : |%-16.p|\n", NULL);
	fflush(stdout);
	printf("23) standart PRINTF : |%20p|\n", NULL);
	ft_printf("23) my       PRINTF : |%20p|\n", NULL);
	fflush(stdout);
	printf("24) standart PRINTF : |%-20.15p|\n", tab);
	ft_printf("24) my       PRINTF : |%-20.15p|\n", tab);
	fflush(stdout);
	free(tab);
	free(tab2);
	 ft_printf("----------------%%d-%%i--------------------\n");
	 ...
	 fflush(stdout);
	 printf("33) standart PRINTF : |%.d|\n", 5);
	 ft_printf("33) my       PRINTF : |%.d|\n", 5);
	 fflush(stdout);
	 printf("34) standart PRINTF : |%d|\n", 0);
	 ft_printf("34) my       PRINTF : |%d|\n", 0);
	 fflush(stdout);
	 printf("35) standart PRINTF : |%-8.5d|\n", 34);
	 ft_printf("35) my       PRINTF : |%-8.5d|\n", 34);
	 fflush(stdout);
	ft_printf("--------------------%%x--------------------\n");
	...
	fflush(stdout);
	printf("21) standart PRINTF : | %-.2x |\n", 0);
	ft_printf("21) my       PRINTF : | %-.2x |\n", 0);
	fflush(stdout);
	printf("22) standart PRINTF : |%-14.6x|\n", 0);
	ft_printf("22) my       PRINTF : |%-14.6x|\n", 0);
	fflush(stdout);
	printf("23) standart PRINTF : |%*.*x|\n", -14, 6, -561);
	ft_printf("23) my       PRINTF : |%*.*x|\n", -14, 6, -561);
	fflush(stdout);
	ft_printf("--------------------%%X--------------------\n");
	printf("01) standart PRINTF : |%X|\n", 34);
	ft_printf("01) my       PRINTF : |%X|\n", 34);
	...
	printf("19) standart PRINTF : |%X|\n", UINT_MAX);
	ft_printf("19) my       PRINTF : |%X|\n", UINT_MAX);
	fflush(stdout);printf("20) standart PRINTF : |%x| |%x|\n", (unsigned int)-1, UINT_MAX + 1);
	ft_printf("20) my       PRINTF : |%x| |%x|\n", (unsigned int)-1, UINT_MAX + 1);
	fflush(stdout);
	printf("21) standart PRINTF : | %-.2X |\n", 0);
	ft_printf("21) my       PRINTF : | %-.2X |\n", 0);
	...
	// ft_printf("%%%");
	// printf("07) standart PRINTF : |%05%|\n");
	// ft_printf("07) my       PRINTF : |%05%|\n");
	// fflush(stdout);
	// ft_printf("|\n\n");
